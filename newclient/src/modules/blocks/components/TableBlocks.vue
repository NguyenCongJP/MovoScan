    ...
    <div>
        <template v-if="pageType == 'home'">
            <template v-if="!isLoading">
                <template v-for="(block, index) in blockData">
                    <table-blocks-row :key="index" :block="block" :page-type="pageType" />
                </template>
            </template>
        ...
        <template v-else>
            <div class="table-responsive mb-2 mb-md-0">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <template v-for="(block, index) in blockData">
                            <table-blocks-row-in-page :key="index" :block="block" :page-type="pageType" />
                        </template>
                    </tbody>
                </table>
            </div>
            <v-card v-if="false" color="white" flat class="pt-3 mt-0">
                <!--
                =====================================================================================
                isLoading / ERROR
                =====================================================================================
...
import TableBlocksRowInPage from '@app/modules/blocks/components/TableBlocksRowInPage.vue'
