<template>
    <v-card class="card" color="white" flat>
        <!--
    =====================================================================================
    ...
    -->
        ...
        <div v-if="hasMore && !isLoading">
            <v-flex xs12>
                <a v-if="!showMore" class="d-block text-primary" @click="setShowMore(true)">Click to see more <i class="ml-2 fas fa-arrow-down"></i></a>
                <a v-else class="d-block text-primary" @click="setShowMore(false)">Click to see less <i class="ml-2 fas fa-arrow-up"></i></a>
            </v-flex>
