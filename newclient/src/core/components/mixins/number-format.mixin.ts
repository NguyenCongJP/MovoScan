...
*/
    ...
    formatVariableUnitCmcValue(value: BigNumber): FormattedNumber {
        return NumberFormatHelper.formatVariableUnitCmcValue(value)
    }
    ...
    formatNonVariableCmcValue(value: BigNumber): FormattedNumber {
        return NumberFormatHelper.formatNonVariableCmcValue(value)
    }
